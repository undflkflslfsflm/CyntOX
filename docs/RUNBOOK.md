...
`acceptance audit` checks the final proof files, gate summary, required artifact contents, artifact snapshot, referenced proof blobs, live smoke stdout, recorded audit artifact, clean Git state, and proof-only post-verification changes.
